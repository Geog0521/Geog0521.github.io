...
def mask_final_GLFC_1k(final_mask, GLFC_1k,lc_list,year):
    """
    ...
    :return:
    """
    masked_GLFC_1k = GLFC_1k[:-4]+"_2.tif"
...
def get_final_mask(city_id=7):

    fid = city_id  # fid=7 Boston Area
    path_intrim = "/Users/patrickchan/Downloads/"
...
if __name__ == '__main__':
    ...
    # city_lis = ["Boston","Dallas","LA_SD"]
    # city_idindex_lis = [7,65,51]
    city_lis = ["GA", "FL", "FL"]
    city_idindex_lis = [60,78,79]
    for i in range(1,2,1):
        final_result = get_final_mask(city_id=city_idindex_lis[i])
        for year in range(2000,2020,1):
            if i==2:
                GLFC_1k = main_dire + "/" + "FL2" + "/" + city_lis[i] + "_" + str(
                    year) + "_lambert_p1k_lc_perc_2_final.tif"
            else:
                GLFC_1k = main_dire + "/" + city_lis[i] + "/" + city_lis[i] + "_" + str(
                    year) + "_lambert_p1k_lc_perc_2_final.tif"

            #GLFC_1k = main_dire+"/"+city_lis[i]+"/"+city_lis[i]+"_"+str(year)+"_lambert_p1k_lc_perc_2_final.tif"
            print(f"processing '{GLFC_1k}'")
            mask_final_GLFC_1k(final_result, GLFC_1k, lc_cover_ls,year)
